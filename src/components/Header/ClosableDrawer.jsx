...
const ClosableDrawer = (props) => {
  ...
  const menus = [
    {func: selectMenu, label: '商品登録', icon: <AddCircleIcon />, id: 'touroku', value: '/product/edit'},
    {func: selectMenu, label: '注文履歴', icon: <HistoryIcon />, id: 'history', value: '/order/history'},
    {func: selectMenu, label: 'プロフィール', icon: <PersonIcon />, id: 'prof', value: '/user/mypage'}
  ];
        ...
        <div onClose={(e) => props.onClose(e)} onKeyDown={(e) => props.onClose(e)} >
          <div className={classes.searchField}>
            <TextInput 
              ...
              required={false} rows={1} value={keyword} type={'text'} inChange={inputKeyword}
            />
            <IconButton>
              <SearchIcon />
            </IconButton>
